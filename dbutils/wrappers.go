...
func Select(ctx context.Context, db sqlx.ExtContext, dest interface{}, query string, args ...interface{}) error {
...
type TxRunner interface {
	BeginTxx(ctx context.Context, opt *sql.TxOptions) (tx *sqlx.Tx, err error)
}
